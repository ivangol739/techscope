...
from .views import PostListView, PostDetailView, PostFromCategoryView, PostCreateView, PostUpdateView, CommentCreateView, PostByTagListView, PostByTagListView, RatingCreateView
